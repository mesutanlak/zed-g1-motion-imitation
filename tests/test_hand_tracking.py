...
from hand_tracking.contracts import HAND_SCHEMA, encode_packet, validate_hand_packet
...
from hand_tracking.retargeting import Dex3Retargeter, compose_targets
...
def test_mock_backend_end_to_end_two_hand_source_packet_and_fusion() -> None:
    intrinsics = CameraIntrinsics(700, 700, 640, 360, 1280, 720)
    pipeline = HandSourcePipeline(1, "host", intrinsics, lambda side: MockBackend(), inference_fps=30)
